...
def generateData():
	sourceFile = '/Users/ericperkins/Berkeley/w205/FinalProject/W205_Final_Data_Source/Product4/data_file_0.txt'
...
def dataCleansing(raw_input):
	...
	if len(data_array) == 9:
		...
		return "Product4," + str(data_date) + "," + str(data_time) + "," + str(data_voltage) + "," + str(data_current) + "," + str(data_power)
	else:
		return None
