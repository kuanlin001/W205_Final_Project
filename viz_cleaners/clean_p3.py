...
def generateData():
	sourceFile = '/Users/ericperkins/Berkeley/w205/FinalProject/W205_Final_Data_Source/Product3/data_file_0.txt'
...
def dataCleansing(raw_input):
	...
	data_current = 'N\A'
	data_power = 'N\A'
	if len(data_array) == 8 and data_array[4].split(' ')[1] == "PS:":
		...
		return "Product3," + str(data_date) + "," + str(data_time) + "," + str(data_voltage) + "," + str(data_current) + "," + str(data_power)
	else:
		return None

#os.mknod('/Users/ericperkins/Berkeley/w205/FinalProject/write_files/write1.txt', 777)
writeFile = open('/Users/ericperkins/Berkeley/w205/FinalProject/write_files/write2.txt', 'a')
